...
@section('content')
    ...
    <div class="container-xxl py-5 py-lg-0">
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 pt-4" style="min-height: 500px;">
                    <div class="position-relative h-100 wow fadeIn" data-wow-delay="0.1s">
                        <img class="position-absolute img-fluid w-100 h-100" src="{{asset($sejarah->thumbnail)}}" style="object-fit: cover; opacity: 0.7;" alt="">
                    </div>
                </div>
                <div class="col-lg-6 align-self-center">
                    <h1 class="mb-4">TENTANG KAMI</h1>
                    <p class="mb-4">{!!Illuminate\Support\Str::limit($sejarah->content,250)!!}</p>
    ...
    <div class="row">
        <div class="col-md-4" style="background-color: rgb(246,235,150);">djdj</div>
        <div class="col-md-4" style="background-color: rgb(248,230,85);">dd</div>
        <div class="col-md-4" style="background-color: rgb(238,213,49);">jdj</div>
    </div>
